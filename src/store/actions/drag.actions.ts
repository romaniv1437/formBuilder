...
export const setActiveField = createAction(DragActionsTypes.setActiveField , props<{name: string, id:string, label?: string}>());
...
export const removeFieldFromForm = createAction(DragActionsTypes.removeFieldFromForm, props<{id: string}>());
export const setEditMode = createAction(DragActionsTypes.setEditMode, props<{id: string, name: string, label: string}>())
